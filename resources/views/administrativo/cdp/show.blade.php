    ...
    <div class="col-md-12 align-self-center">
        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item active"><a class="tituloTabs" data-toggle="tab" href="#info">Información CDP: {{ $conteo }}</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="info" class="tab-pane fade in active">
                    <div class="row ">
                        ...
                        <div class="col-sm-3"><h4><b>Número del CDP:</b>&nbsp;{{ $conteo}}</h4></div>
                        <br>
                        <br>
