            ...
            <div class="form-validation">
                <div class="table-responsive">
                    ...
                    <div class="col-md-8 align-self-center">
                        ...
                        <form class="form-valide" action="{{url('/administrativo/pac')}}" method="POST" enctype="multipart/form-data" id="form">
                            <center>
                                ...
                                <div class="col-md-6 align-self-center">
                                    <table class="table-bordered" width="100%">
                                        ...
                                        <tr class="text-center">
                                            <td>1</td>
                                            <td>Enero</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="enero" id="enero" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>2</td>
                                            <td>Febrero</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="febrero" id="febrero" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>3</td>
                                            <td>Marzo</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="marzo" id="marzo" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>4</td>
                                            <td>Abril</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="abril" id="abril" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>5</td>
                                            <td>Mayo</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="mayo" id="mayo" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>6</td>
                                            <td>Junio</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="junio" id="junio" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>7</td>
                                            <td>Julio</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="julio" id="julio" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>8</td>
                                            <td>Agosto</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="agosto" id="agosto" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>9</td>
                                            <td>Septiembre</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="septiembre" id="septiembre" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>10</td>
                                            <td>Octubre</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="octubre" id="octubre" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>11</td>
                                            <td>Noviembre</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="noviembre" id="noviembre" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td>12</td>
                                            <td>Diciembre</td>
                                            <td><input type="number" style="text-align: center" class="form-control" onchange="distribucion()" name="diciembre" id="diciembre" value="0" min="0"></td>
                                        </tr>
                                        <tr class="text-center">
