                    ...
                    @if(count($codes) > 0)
                        ...
                        @else
                            ...
                            <div class="alert alert-danger">
                                <center>
                                    No hay rubros asignados a codigos contractuales, se recomienda asignarlos.
                                    <a href="{{ url('presupuesto/informes/contractual/asignar') }}" class="btn btn-success btn-block">ASIGNAR</a>
                                </center>
                            </div>
                        @endif
                            <br>
