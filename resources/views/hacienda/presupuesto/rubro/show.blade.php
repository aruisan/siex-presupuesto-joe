...
@section('content')
    ...
    <ul class="nav nav-pills">
        <li class="nav-item">
            <a class="nav-link regresar"  href="{{ url('/presupuesto/'.$rubro->vigencia->id ) }}">Volver a Presupuesto</a>
        </li>
...
<<<<<<< HEAD
            ...
            <div id="movimientos" class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 tab-pane">
                ...
                @if($files != 0)
                    ...
                    <hr>
=======
                 <div id="datos" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-md-offset-2 col-lg-offset-2 tab-pane fade in active">
            ...
            <div id="cdp" class="col-xs-12 col-sm-12 col-md-12 col-lg-12  tab-pane">
                    ...
                    <center>
                        <h2>CDP's Asignados al Rubro</h2>
                    </center>
